...
<body class="bg-gray-50">
            ...
            <form id="signupForm" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex space-x-3">
                        <button type="button" onclick="selectAvatar('👩‍🏫')" class="avatar-btn p-3 border-2 border-gray-300 rounded-lg hover:border-green-500 transition-colors">👩‍🏫</button>
                        <button type="button" onclick="selectAvatar('👨‍🏫')" class="avatar-btn p-3 border-2 border-gray-300 rounded-lg hover:border-green-500 transition-colors">👨‍🏫</button>
                        <button type="button" onclick="selectAvatar('👩‍💼')" class="avatar-btn p-3 border-2 border-gray-300 rounded-lg hover:border-green-500 transition-colors">👩‍💼</button>
                        <button type="button" onclick="selectAvatar('👨‍💼')" class="avatar-btn p-3 border-2 border-gray-300 rounded-lg hover:border-green-500 transition-colors">👨‍💼</button>
                        <button type="button" onclick="selectAvatar('👤')" class="avatar-btn p-3 border-2 border-gray-300 rounded-lg hover:border-green-500 transition-colors">👤</button>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl p-6 shadow-md">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <button onclick="openScheduleManager()" class="p-4 bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-lg card-hover feature-icon">
                            <div class="text-2xl mb-2">📅</div>
                        ...
                        <button onclick="openBestStudentManager()" class="p-4 bg-gradient-to-br from-pink-500 to-pink-600 text-white rounded-lg card-hover feature-icon">
                            <div class="text-2xl mb-2">🏆</div>
    ...
    <script>
        ...
        const defaultUsers = {
            'guru1': { password: 'guru123', name: 'Bu Sari Wijayanti', role: 'Guru Kelas 5A', avatar: '👩‍🏫' },
            'guru2': { password: 'guru456', name: 'Pak Budi Santoso', role: 'Guru Kelas 5B', avatar: '👨‍🏫' },
            'kepsek': { password: 'kepsek123', name: 'Drs. Ahmad Hidayat, M.Pd', role: 'Kepala Sekolah', avatar: '👨‍💼' },
            'admin': { password: 'admin123', name: 'Admin Sekolah', role: 'Administrator', avatar: '👤' }
        };
        ...
        function openAttendance() {
            ...
            if (studentsData.students.length === 0) {
                ...
                studentCheckboxes = studentsData.students.map((student, index) => 
                    `<div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg mb-2 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <label for="attend_${student.replace(/\s+/g, '_')}" class="font-medium text-gray-800">${student}</label>
                        </div>
                        <div class="flex items-center space-x-3">
                            <input type="checkbox" id="attend_${student.replace(/\s+/g, '_')}" checked class="attendance-checkbox w-4 h-4 text-blue-600 rounded focus:ring-blue-500">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input id="attendanceDate" type="date" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="${new Date().toISOString().split('T')[0]}">
                            </div>
                            <div>
                                <label class="block text-sm font-medium mb-2 text-gray-700">Mata Pelajaran</label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-medium text-gray-800 mb-4 flex items-center">
                            ...
                            ${studentsData.students.length > 0 ? `<span class="ml-2 bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Kelas ${extractClassFromRole(currentUser.role) || '5A'}</span>` : ''}
                        </h4>
        ...
        function quickAttendance() {
            ...
            const content = `
                <div class="space-y-4">
                    <div class="bg-blue-50 p-3 rounded-lg">
                        <h4 class="font-medium text-blue-800 mb-2">⚡ Absensi Cepat - ${Math.min(10, studentsData.students.length)} Siswa Pertama</h4>
        ...
        function saveQuickGrade(studentName) {
            const subject = document.getElementById('quickGradeSubject').value.trim();
        ...
        function prepareReportData(type, period) {
            ...
            if (type === 'nilai') {
                ...
                return {
                    ...
                    headers,
                    rows,
                    summary: `<p>Siswa dengan nilai baik (≥80): ${rows.filter(r => r[5] === 'Baik').length}</p>`
                };
            }
        }
        ...
        function updateClassSchedule(userClass) {
            ...
            const scheduleKey = userClass ? `schedule_${userClass}` : 'schedule_default';
            ...
            if (relevantAnnouncements.length === 0) {
                announcementsContainer.innerHTML = `
                    <div class="text-center text-gray-500 py-4">
                        ...
                        ${(currentUser.role === 'Kepala Sekolah' || currentUser.role === 'Administrator') ? 
        ...
        function openScheduleManager() {
            ...
            const schedulesList = schedules.map((schedule, index) => `
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-teal-50 p-4 rounded-lg border border-teal-200">
                        <h4 class="font-medium text-teal-800 mb-4 flex items-center">
                            📅 Tambah Jadwal Baru
                            <span class="ml-2 bg-teal-100 text-teal-800 text-xs px-2 py-1 rounded-full">Kelas ${userClass || '5A'}</span>
                        </h4>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-medium text-gray-800 mb-4 flex items-center">
                            ...
                            <span class="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">${schedules.length} mata pelajaran</span>
                        </h4>
                        
                        <div class="max-h-96 overflow-y-auto">
                            ${schedulesList || '<div class="text-center text-gray-500 py-8">Belum ada jadwal. Tambahkan mata pelajaran pertama!</div>'}
                        </div>
                    </div>
        ...
        function selectScheduleColor(color) {
            ...
            event.target.closest('.schedule-color-btn').classList.add('ring-2', 'ring-offset-2', `ring-${color}-400`);
        }
        ...
        function addSchedule() {
            ...
            document.getElementById('scheduleSubjectCustom').classList.add('hidden');
            ...
            alert(`Jadwal "${subject}" berhasil ditambahkan!\n\nWaktu: ${startTime} - ${endTime}`);
        ...
        function deleteSchedule(index) {
            ...
            if (confirm(`Apakah Anda yakin ingin menghapus jadwal "${schedule.subject}"?\n\nWaktu: ${schedule.time}`)) {
        ...
        function updateTopStudents(userClass) {
            ...
            const approvedBestStudents = JSON.parse(localStorage.getItem('approvedBestStudents') || '[]');
            ...
            topStudentsContainer.innerHTML = approvedBestStudents.slice(0, 3).map((student, index) => `
        ...
        function openBestStudentManager() {
            const userClass = extractClassFromRole(currentUser.role);
            const classKey = userClass ? `bestStudents_${userClass}` : 'bestStudents_default';
            const myBestStudents = JSON.parse(localStorage.getItem(classKey) || '[]');
            
            const bestStudentsList = myBestStudents.map((student, index) => `
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-pink-50 p-4 rounded-lg border border-pink-200">
                        <h4 class="font-medium text-pink-800 mb-4 flex items-center">
                            ...
                            <span class="ml-2 bg-pink-100 text-pink-800 text-xs px-2 py-1 rounded-full">Kelas ${userClass || '5A'}</span>
                        </h4>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="bestStudentName" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500">
                                    <option value="">-- Pilih Siswa --</option>
                                    ${studentsData.students.map(student => `<option value="${student}">${student}</option>`).join('')}
                                </select>
                            </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-medium text-gray-800 mb-4 flex items-center">
                            ...
                            <span class="ml-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">${myBestStudents.length} siswa</span>
                        </h4>
                        
                        <div class="max-h-96 overflow-y-auto">
                            ${bestStudentsList || '<div class="text-center text-gray-500 py-8">Belum ada siswa terbaik. Pilih siswa terbaik pertama!</div>'}
                        </div>
                    </div>
        ...
        function addBestStudent() {
            ...
            const achievement = document.getElementById('bestStudentAchievement').value.trim();
            const reason = document.getElementById('bestStudentReason').value.trim();
            ...
            const existingStudent = myBestStudents.find(student => student.studentName === studentName);
            ...
            const globalBestStudents = JSON.parse(localStorage.getItem('approvedBestStudents') || '[]');
            
            // Remove if already exists globally (to avoid duplicates)
            const existingGlobalIndex = globalBestStudents.findIndex(s => s.studentName === studentName);
            ...
            localStorage.setItem('approvedBestStudents', JSON.stringify(globalBestStudents));
        ...
        function removeBestStudent(index) {
            ...
            if (confirm(`Apakah Anda yakin ingin menghapus "${student.studentName}" dari daftar siswa terbaik?\n\nSiswa akan dihapus dari dashboard juga.`)) {
                ...
                const globalBestStudents = JSON.parse(localStorage.getItem('approvedBestStudents') || '[]');
                const globalIndex = globalBestStudents.findIndex(s => s.studentName === student.studentName);
                if (globalIndex !== -1) {
                    globalBestStudents.splice(globalIndex, 1);
                    localStorage.setItem('approvedBestStudents', JSON.stringify(globalBestStudents));
                }
                
                alert(`"${student.studentName}" berhasil dihapus dari daftar siswa terbaik!`);
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'971d705267e94573',t:'MTc1NTY0NjIyNi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
